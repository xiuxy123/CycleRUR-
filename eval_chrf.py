...
def main():
    ...
    argParser.add_argument("-R", "--reference", help="reference translation", default="data/webnlg/test_ref.txt")
    argParser.add_argument("-H", "--hypothesis", help="hypothesis translation", default="output/data2text.generations")
    ...
    with open(args.hypothesis, 'r', encoding='utf-8') as file:
        lines = file.readlines()

    with open(args.hypothesis, 'w', encoding='utf-8') as file:
        for line in lines:
    ...
    #     'CIDEr', 'SkipThoughtCS', 'EmbeddingAverageCosineSimilarity',
