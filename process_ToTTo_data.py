...
# from process.table_linearization import linearize_table_with_index
from process.table_linearization_src import linearize_table_with_index

# unlabeled_totto_test_data
flags.DEFINE_string("input_path", "data/totto_data/train/totto_train_data.jsonl", "Input json file.")

flags.DEFINE_string("output_path", "data/totto_data/train/linearized_train.jsonl", "Output directory.")
